            ...
            <div className="w-full px-4 lg:w-3/4">
              <div className="blog-details blog-details-docs rounded-sm bg-white py-11 px-8 shadow-three dark:bg-gray-dark sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]">
                ...
                <p className="text-base text-body-color dark:text-body-color-dark">
                  የድርጅቱ ግብ  በአመት ውስጥ ሇተወሰነ ተማሪዎች ነፃ የትምህርት እድል በሀገር ውስጥ እና ከሀገር
                  ውጪ ማመቻቸት፡-  ከገቡት ካምፕር ውስጥ የራሳቸውን ተሰጥኦ ላገኙት ድጋፍና ክትትል ማድረግ 
                  ጠንካራና ውጤታማ የሆነ የሀገር በቀል ድጋፍ ሰጪ ድርጅት ማቋቋም  ሙያተኞችን በበጐ ፈቃደኝነት
                  ሇቀጣይ ትውልድ እውቀትና ተሞክሮን የሚያስተላልፉበት ተቋም ማድረግ
                </p>
                <p className="text-base text-body-color dark:text-body-color-dark">
                  Please visit:{" "}
                  <b>
