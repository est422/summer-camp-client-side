      ...
      <section className="pb-20 lg:pb-25 xl:pb-30 overflow-hidden">
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <Image
                src="/images/camp/49096ed59d3d9c96eccb428a2fdf40922f32ef33.jpg"
                alt="About"
            ...
            >
              ...
              {/* <h4 className="relative font-bold text-black dark:text-white text-xl xl:text-about mb-6">
                To empower children and adolescents globally to develop their
                natural talents and skills
                <span className="inline-block relative before:absolute before:bottom-2.5 before:left-0 before:w-full before:h-3 before:bg-lightmeta dark:before:bg-titlebgdark before:-z-1">
                  and to create a productive generation that is empowered by
                  ethics.
                </span>
              </h4>
              <p>
                To empower children and adolescents globally to develop their
                natural talents and skills and to create a productive generation
                that is empowered by ethics.
              </p> */}
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>
                    We offer a variety of activities to choose from, so there's
              ...
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  <h5 className="text-black dark:text-white text-metatitle2 mb-0.5">
                    Hand Picked Counselors
                  </h5>
                  <p>
                    Our camp counselors are experienced and enthusiastic, and
                    they're dedicated to making sure your child has a great
                    time.
                  </p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>
                    Our camp is located in a beautiful natural setting, so kids
                    can enjoy the outdoors and learn about nature.
                  </p>
                </div>
              </div>
              <div className="mt-7.5 flex items-center gap-5">
                ...
                <div className="w-3/4">
                  ...
                  <p>
                    We offer a safe and supportive environment where kids can
      ...
      <section>
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 2xl:px-0 overflow-hidden">
          <div className="flex items-center gap-8 lg:gap-32.5">
            ...
            >
              <h4 className="text-black dark:text-white font-medium uppercase">
                Packed with Fun and Educational Activities
              </h4>
              <h2 className="relative font-bold text-black dark:text-white text-2xl xl:text-2xl mb-6">
                All
              ...
              <ul>
                <li>Play sports and games</li>
                <li>Learn arts and crafts</li>
                <li>Do STEM projects And much more!</li>
              </ul>
            ...
            >
              <Image
                src="/images/camp/camp-addis.png"
                alt="About"
                className="dark:hidden"
                fill
              />
