...
const Footer = () => {
  return (
    <>
      <footer
        // style={{ backgroundColor: "rgb(96 165 250)", color: "rgb(0 0 0)" }}
        // {{ backgroundColor: "#63B3ED", color: "black" }}
        className="bg-meta text-black dark:text-meta  dark:bg-blacksection border-t border-stroke dark:border-strokedark"
      >
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0 min-h-fit">
          {/* <!-- Footer Top --> */}
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap lg:justify-between gap-8 lg:gap-0">
              ...
              >
                ...
                <a
                  href="#"
                  className=" dark:text-white font-medium text-itemtitle"
                >
                  admin@campaddis.com
                </a>
              </motion.div>

              <div className="w-full lg:w-2/3 xl:w-7/12 dark:text-meta text-blackho flex flex-col md:flex-row md:justify-between gap-8 md:gap-0">
                <motion.div
                  variants={{
                    hidden: {
                      opacity: 0,
          ...
          <div className="border-t border-stroke dark:border-strokedark flex flex-wrap flex-col lg:flex-row items-center justify-center lg:justify-between gap-5 lg:gap-0 py-7">
            ...
            <motion.div
              ...
              className="animate_top"
            >
              <p>&copy; 2023 Camp Addis. All rights reserved</p>
            </motion.div>
