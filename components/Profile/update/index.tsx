...
const UpdateProfile = ({ profile }: any) => {
  ...
  const [formData, setFormData] = useState<ProfileFormData>({
    ...
    fileName: initialProfile?.receipt || "",
    fname: initialProfile?.firstName || "",
    lname: initialProfile?.lastName || "",
    relationshiptocamper: initialProfile?.relationshiptocamper || "",
    phone: initialProfile?.addressInfo?.phone || "",
    address: initialProfile?.addressInfo?.address || "",
    city: initialProfile?.addressInfo?.city || "",
    images: [],
    receipt: [],
  });
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    data.append("relationshiptocamper", formData.relationshiptocamper);
            ...
            >
              ...
              /> */}
                  ...
                  <div className="flex flex-col mb-2">
                    ...
                    <input
                      type="text"
                      id="relationshiptocamper"
                      name="relationshiptocamper"
                      //   required
                      value={formData.relationshiptocamper}
                      onChange={handleChange}
                      className="border border-gray-300 rounded-md p-2"
                    />
                  </div>
