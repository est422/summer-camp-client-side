...
const ForgatPasswordForm = () => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      if (!res || res.ok !== true) {
        setIsLoading(false);
        setMessage("Unable to change users password");
        // router.push("/error");
      } else {
        // router.refresh();
        ...
        setIsLoading(false);
        setMessage("");
        setSuccessFull("Password change successfull");
              ...
              <div className="flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
                ...
                <div className="w-full">
                  <h5 className="mb-3 text-lg font-semibold text-black dark:text-[#34D399] ">
                    Password Changed Successfully Please wait...
                  </h5>
                </div>
              </div>
            </h2>
          ...
          <div className="mx-auto max-w-c-1016 relative z-1 pt-10 lg:pt-15 xl:pt-20 pb-7.5 px-7.5 lg:px-15 xl:px-20">
            ...
            >
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="text-center mt-12.5 py-5">
                  <p>
                    Don't have an account?{" "}
                    <Link
                      className="text-black border-t border-stroke dark:border-strokedark dark:text-white hover:text-primary hover:dark:text-primary"
                      href="/auth/signup"
                    >
                      Sign Up
                    </Link>
