...
const VolunteerDetailsComponent = () => {
        ...
        <section className="pt-32.5 lg:pt-45 xl:pt-50 pb-12.5 lg:pb-25 xl:pb-20">
          <div className="mx-auto max-w-c-1016 relative z-1 pt-10 lg:pt-15 xl:pt-20 pb-7.5 px-7.5 lg:px-15 xl:px-20">
            ...
            >
              <Image
                src={
                  volunteerProfile.imageName === "undefined" ||
                  volunteerProfile.imageName === null
                    ? "/Unknown_person.jpg"
                    : `/${volunteerProfile.imageName}`
                }
                alt="volunteerProfile-img"
                width={250}
                height={150}
              />
              <div className="mt-6 border-t border-gray-100">
                <dl className="divide-y divide-gray-100">
                  ...
                  <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    ...
                    <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                      {volunteerProfile.skillsandabilities}
                    </dd>
                  </div>
                  <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                    <dt className="text-sm font-bold leading-6 text-gray-900">
              ...
              <div className="ml-4 flex items-center justify-center">
                <button
                  ...
                  onClick={(e) =>
                    router.push(`/volunteers/update/${volunteerProfile.id}`)
                  }
              ...
              <div className="ml-4 flex items-center justify-center pt-5">
                <a
                  href={"/"}
                  // onClick={(e) => handleReject(e)}
                  className="flex items-center justify-center bg-black hover:bg-black ease-in-out duration-300 text-white text-regular rounded-full py-2.5 px-7.5 p-5"
                >
                  Cancel
                </a>
              </div>
...
export default VolunteerDetailsComponent;
